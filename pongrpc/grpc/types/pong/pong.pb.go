...
var file_pong_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x22, 0x25, 0x0a, 0x0f, 0x47, 0x61, 0x6d, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x42, 0x79, 0x74, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x3f, 0x0a, 0x0b, 0x50, 0x6c, 0x61,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x22, 0xfc, 0x04, 0x0a, 0x0a, 0x47,
	...
	0x52, 0x08, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x49, 0x64, 0x32, 0x83, 0x01, 0x0a, 0x08, 0x50,
	...
	0x42, 0x11, 0x5a, 0x0f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x70,
...
var file_pong_proto_goTypes = []interface{}{
	(*GameUpdateBytes)(nil),   // 0: pong.GameUpdateBytes
	(*PlayerInput)(nil),       // 1: pong.PlayerInput
	(*GameUpdate)(nil),        // 2: pong.GameUpdate
	(*GameStreamRequest)(nil), // 3: pong.GameStreamRequest
}
var file_pong_proto_depIdxs = []int32{
	1, // 0: pong.PongGame.SendInput:input_type -> pong.PlayerInput
	3, // 1: pong.PongGame.StreamUpdates:input_type -> pong.GameStreamRequest
	2, // 2: pong.PongGame.SendInput:output_type -> pong.GameUpdate
	0, // 3: pong.PongGame.StreamUpdates:output_type -> pong.GameUpdateBytes
